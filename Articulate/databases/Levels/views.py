...
class get_lvl_1_sd(viewsets.ReadOnlyModelViewSet):
    queryset = lvl_1_sd.objects.all()
    serializer_class = lvl_1_sd_serializer

    

class get_lvl_2_sd(viewsets.ModelViewSet):
    queryset = lvl_2_sd.objects.all()
    serializer_class = lvl_2_sd_serializer

        

class get_lvl_3_sd(viewsets.ModelViewSet):
    queryset = lvl_3_sd.objects.all()
    serializer_class = lvl_2_sd_serializer
