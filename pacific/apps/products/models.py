...
class Final_Product(models.Model):
    Product_Name = models.CharField(max_length=30)
    Product_image = models.ImageField(upload_to='Category3_Products_images/')
    category2_fk = models.ForeignKey(  Category1, on_delete=models.CASCADE, related_name='categories2' , verbose_name='Category 1 Name')

    def __str__(self):
        return self.Product_Name
    
    class Meta:
        verbose_name = "Final Product in Category 2"
...
class Final_Product_For_C2(models.Model):
    ...
    class Meta:
        verbose_name = "Final Product in Category 3"
